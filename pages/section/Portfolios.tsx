...
import { PinContext } from '../components/Pin';

type Props = {}

const Portfolios = (props: Props) => {
  const pinLocation = React.useContext(PinContext);
  console.log("From portfolio:", pinLocation);
  return (
    <PinContext.Provider value={pinLocation}>
